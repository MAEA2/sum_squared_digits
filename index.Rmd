...
このとき、こちらの結城先生のつぶやき[tweet](https://twitter.com/hyuki/status/977808341383593985)によれば、数列$n,f_{10}(n_{(10)}),f_{10}(f_10(n_{(10)})),\ldots$は,次の$2$つのパターンに落ちるそうです。
...
[証明] 補題4より$n\leq 122_{(6)}=50$の範囲で調べれば良いことがわかる。$50$個くらいなら有限なので有限なので、全部書き下してみる。
